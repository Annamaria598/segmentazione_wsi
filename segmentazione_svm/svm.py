...
print("Generazione segmentazione img 1001R")
image_segmentation(
    svm,
...
# Generazione dei grafici su una sola immagine di test
print("Generazione segmentazione img 1002R")
image_segmentation(
    svm,
...
# Generazione dei grafici su una sola immagine di test
print("Generazione segmentazione img 101R")
image_segmentation(
    svm,
...
# Generazione dei grafici su una sola immagine di test
print("Generazione segmentazione img 102R")
image_segmentation(
    svm,
...
# Generazione dei grafici su una sola immagine di test
print("Generazione segmentazione img 103R")
image_segmentation(
    svm,
...
# Generazione dei grafici su una sola immagine di test
print("Generazione segmentazione img 104R")
image_segmentation(
    svm,
...
# Generazione dei grafici su una sola immagine di test
print("Generazione segmentazione img 105R")
image_segmentation(
    svm,
...
print("Calcolo matthews score e matrice di confusione su tutte le immagini...")
...
print("Matthews score su tutte le immagini: " + str(mc))

def normalizza_cm(cm):
    """Normalizzazione della confusion matrix come
    ottenuta dalla funzione test_on_multiple_images"""
