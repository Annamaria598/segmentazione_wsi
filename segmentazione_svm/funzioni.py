...
def train_on_multi(
    ...
    matthews_score, c_matrix = test_on_multiple_images(svm, test_images, test_images_segmented, window_size, feature_names, window_size_postprocessing)

    return svm, matthews_score, c_matrix
